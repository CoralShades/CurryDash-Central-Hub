...
- **Status:** [x] done
- **Partial:** commit 0a184ff exists — complete gaps only (hardcoded reviewStatus/ciStatus, missing breadcrumbs, incomplete stakeholder view, missing role registration, incomplete tests)
- **Epic:** GitHub Integration & Repository Activity
- **FRs:** FR12, FR19
